...
export class SessionManager {
    ...
    ask(parts) {
        ...
        wasm.sessionmanager_ask(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @param {string} parts
     */
    add_reply(parts) {
        const ptr0 = passStringToWasm0(parts, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.sessionmanager_add_reply(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @returns {string}
     */
    get_session() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.sessionmanager_get_session(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    get_last_reply() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.sessionmanager_get_last_reply(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('session_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
